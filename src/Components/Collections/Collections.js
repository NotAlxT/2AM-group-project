  ...
  return (
    <>
     <section class="collection-container">
        <a href="landing" class="collection" onclick="trackClick3()">
        ...
        <a href="landing" class="collection" onclick="trackClick2()">
        ...
        <a href="landing" class="collection" onclick="trackClick1()">
